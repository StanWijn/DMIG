...
###  Multiple functions for graphical representation of a cost -effectiveness analysis  ########
...
getFrontier <- function(CEmat, maxWTP = Inf){
  # Name: getFrontier.R
...
number_ticks <- function(n) {
  ...
  } #Function for number of ticks in ggplot
